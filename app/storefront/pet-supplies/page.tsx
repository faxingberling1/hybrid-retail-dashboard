...
export default async function CategoryLandingPage() {
  const slug = "pet-supplies";
  const theme = {
  "bg": "bg-gradient-to-r from-amber-700 to-orange-800",
  "text": "text-white",
  "pText": "text-amber-50",
  "linkBg": "bg-white text-amber-800 hover:bg-amber-50",
  "accentBorder": "hover:border-amber-700",
  "accentHoverBg": "hover:bg-amber-50",
  "title": "For Your Furry Friends",
  "desc": "Nutritious pet food, fun toys, and grooming essentials for happy pets."
};

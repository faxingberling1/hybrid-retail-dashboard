...
export default async function StorefrontLayout({ children, params }: { children: React.ReactNode, params: Promise<{ industry: string }> }) {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 font-sans selection:bg-rose-500/20 pb-16 md:pb-0">
      ...
      <StoreHeader categories={parentCategories} customLogoUrl={themeConfig.logoUrl} industry={industry} />
      <AuthModal />
      <FlashDealsPopup />

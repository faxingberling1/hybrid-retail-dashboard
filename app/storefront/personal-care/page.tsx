...
export default async function CategoryLandingPage() {
  const slug = "personal-care";
  const theme = {
  "bg": "bg-gradient-to-r from-teal-400 to-emerald-500",
  "text": "text-white",
  "pText": "text-teal-50",
  "linkBg": "bg-white text-teal-700 hover:bg-teal-50",
  "accentBorder": "hover:border-teal-500",
  "accentHoverBg": "hover:bg-teal-50",
  "title": "Self-Care Starts Here",
  "desc": "Premium skincare, hair care, and grooming essentials for your daily routine."
};

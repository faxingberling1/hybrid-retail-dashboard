...
export default async function CategoryLandingPage() {
  const slug = "pantry-staples";
  const theme = {
  "bg": "bg-gradient-to-r from-orange-400 to-amber-600",
  "text": "text-white",
  "pText": "text-orange-50",
  "linkBg": "bg-white text-orange-700 hover:bg-orange-50",
  "accentBorder": "hover:border-orange-500",
  "accentHoverBg": "hover:bg-orange-50",
  "title": "The Heart of Your Kitchen",
  "desc": "Premium rice, pulses, imported oils, and aromatic spices to perfect your recipes."
};

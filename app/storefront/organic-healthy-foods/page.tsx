...
export default async function CategoryLandingPage() {
  const slug = "organic-healthy-foods";
  const theme = {
  "bg": "bg-gradient-to-r from-lime-500 to-green-600",
  "text": "text-white",
  "pText": "text-lime-50",
  "linkBg": "bg-white text-lime-700 hover:bg-lime-50",
  "accentBorder": "hover:border-lime-500",
  "accentHoverBg": "hover:bg-lime-50",
  "title": "Nourish Your Body",
  "desc": "Certified organic produce, gluten-free snacks, and superfoods for a healthy lifestyle."
};

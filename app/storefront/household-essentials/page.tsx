...
export default async function CategoryLandingPage() {
  const slug = "household-essentials";
  const theme = {
  "bg": "bg-gradient-to-r from-slate-500 to-gray-700",
  "text": "text-white",
  "pText": "text-slate-50",
  "linkBg": "bg-white text-slate-700 hover:bg-slate-50",
  "accentBorder": "hover:border-slate-500",
  "accentHoverBg": "hover:bg-slate-50",
  "title": "For a Better Home",
  "desc": "Paper towels, trash bags, and everyday household products for smooth running."
};

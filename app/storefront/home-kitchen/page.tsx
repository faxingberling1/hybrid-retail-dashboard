...
export default async function CategoryLandingPage() {
  ...
  const theme = {
  "bg": "bg-gradient-to-r from-stone-500 to-stone-700",
  "text": "text-white",
  "pText": "text-stone-50",
  "linkBg": "bg-white text-stone-700 hover:bg-stone-50",
  "accentBorder": "hover:border-stone-500",
  "accentHoverBg": "hover:bg-stone-50",
  "title": "Elevate Your Space",
  "desc": "Quality cookware, storage containers, and elegant dining essentials."
};

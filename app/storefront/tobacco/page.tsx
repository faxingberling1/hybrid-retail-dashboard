...
export default async function CategoryLandingPage() {
  const slug = "tobacco";
  const theme = {
  "bg": "bg-gradient-to-r from-stone-700 to-neutral-900",
  "text": "text-white",
  "pText": "text-stone-300",
  "linkBg": "bg-white text-stone-900 hover:bg-stone-100",
  "accentBorder": "hover:border-stone-700",
  "accentHoverBg": "hover:bg-stone-100",
  "title": "Tobacco Products",
  "desc": "Premium cigars, cigarettes, and smoking accessories."
};

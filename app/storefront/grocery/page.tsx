...
export default async function CategoryLandingPage() {
  ...
  "text": "text-white",
  "pText": "text-violet-50",
  "linkBg": "bg-white text-violet-700 hover:bg-violet-50",
  "accentBorder": "hover:border-violet-500",
  "accentHoverBg": "hover:bg-violet-50",
  "title": "Your Everyday Essentials",
  "desc": "Stock up your kitchen with quality ingredients, organic products, and imported grocery items."
};

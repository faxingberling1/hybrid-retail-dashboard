...
export default async function CategoryLandingPage() {
  ...
  const theme = {
  "bg": "bg-gradient-to-r from-sky-400 to-indigo-500",
  "text": "text-white",
  "pText": "text-sky-50",
  "linkBg": "bg-white text-indigo-700 hover:bg-sky-50",
  "accentBorder": "hover:border-indigo-500",
  "accentHoverBg": "hover:bg-indigo-50",
  "title": "Quench Your Thirst",
  "desc": "Refreshing juices, energizing coffee, soft drinks, and premium hydration options."
};

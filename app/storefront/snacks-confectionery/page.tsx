...
export default async function CategoryLandingPage() {
  const slug = "snacks-confectionery";
  const theme = {
  "bg": "bg-gradient-to-r from-pink-500 to-rose-500",
  "text": "text-white",
  "pText": "text-pink-50",
  "linkBg": "bg-white text-pink-700 hover:bg-pink-50",
  "accentBorder": "hover:border-pink-500",
  "accentHoverBg": "hover:bg-pink-50",
  "title": "Cravings Satisfied",
  "desc": "Crunchy chips, premium chocolates, and savory snacks for movie nights and quick bites."
};

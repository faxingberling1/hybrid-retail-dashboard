...
export default async function CategoryLandingPage() {
  const slug = "flowers-gifts";
  const theme = {
  "bg": "bg-gradient-to-r from-fuchsia-500 to-pink-600",
  "text": "text-white",
  "pText": "text-fuchsia-50",
  "linkBg": "bg-white text-fuchsia-700 hover:bg-fuchsia-50",
  "accentBorder": "hover:border-fuchsia-500",
  "accentHoverBg": "hover:bg-fuchsia-50",
  "title": "Say It With Love",
  "desc": "Beautiful fresh bouquets, elegant gift baskets, and sweet surprises."
};

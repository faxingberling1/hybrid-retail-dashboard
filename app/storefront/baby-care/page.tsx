...
export default async function CategoryLandingPage() {
  const slug = "baby-care";
  const theme = {
  "bg": "bg-[#ffc000]",
  "text": "text-slate-900",
  "pText": "text-slate-800",
  "linkBg": "bg-slate-900 text-white hover:bg-slate-800",
  "accentBorder": "hover:border-[#ffc000]",
  "accentHoverBg": "hover:bg-[#ffc000]/10",
  "title": "Everything for Your Little One",
  "desc": "From organic baby food to the softest diapers. Shop our curated selection of premium baby care."
};

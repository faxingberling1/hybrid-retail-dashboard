...
export default async function CategoryLandingPage() {
  const slug = "frozen-foods";
  const theme = {
  "bg": "bg-gradient-to-r from-cyan-500 to-blue-600",
  "text": "text-white",
  "pText": "text-cyan-50",
  "linkBg": "bg-white text-cyan-700 hover:bg-cyan-50",
  "accentBorder": "hover:border-cyan-500",
  "accentHoverBg": "hover:bg-cyan-50",
  "title": "Convenient & Delicious",
  "desc": "Stock up your freezer with ready meals, premium frozen veggies, and sweet frozen desserts."
};

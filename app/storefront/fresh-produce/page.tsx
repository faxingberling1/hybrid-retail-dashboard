...
export default async function CategoryLandingPage() {
  const slug = "fresh-produce";
  const theme = {
  "bg": "bg-gradient-to-r from-emerald-500 to-emerald-700",
  "text": "text-white",
  "pText": "text-emerald-50",
  "linkBg": "bg-white text-emerald-700 hover:bg-emerald-50",
  "accentBorder": "hover:border-emerald-500",
  "accentHoverBg": "hover:bg-emerald-50",
  "title": "Farm Fresh to Your Table",
  "desc": "Crisp vegetables, juicy fruits, and fresh herbs hand-picked daily for the best quality."
};

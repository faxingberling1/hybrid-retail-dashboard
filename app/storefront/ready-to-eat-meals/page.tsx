...
export default async function CategoryLandingPage() {
  const slug = "ready-to-eat-meals";
  const theme = {
  "bg": "bg-gradient-to-r from-red-400 to-rose-600",
  "text": "text-white",
  "pText": "text-red-50",
  "linkBg": "bg-white text-red-700 hover:bg-red-50",
  "accentBorder": "hover:border-red-500",
  "accentHoverBg": "hover:bg-red-50",
  "title": "Delicious & Instant",
  "desc": "Chef-prepared meals, hot deli items, and quick microwave dinners."
};

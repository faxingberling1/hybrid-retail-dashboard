      ...
      <div className="px-6 h-16 flex items-center justify-between">
          ...
          <div className="hidden lg:block ml-4">
            <div className="relative">
              ...
              <input
                ...
                className="pl-10 pr-4 py-2 w-64 bg-gray-100 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent"
              />
            </div>
          </div>
        </div>
        ...
        <div className="flex items-center space-x-4">
          <div className="bg-blue-50 px-3 py-1 rounded-lg">
            <span className="text-sm font-medium text-blue-700">Terminal #01</span>
          </div>

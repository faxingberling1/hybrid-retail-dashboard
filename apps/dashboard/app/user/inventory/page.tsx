...
export default function UserInventoryPage() {
    ...
    useEffect(() => {
        console.log("🔍 User Inventory Debug:")
        ...
        <div className="max-w-[1600px] mx-auto space-y-8 pb-12">
            ...
            <div className="flex flex-col xl:flex-row xl:items-end justify-between gap-6">
                <div className="flex items-center gap-5">
                    <div className="p-4 bg-gradient-to-br from-indigo-600 to-blue-700 rounded-3xl shadow-2xl shadow-indigo-500/20 ring-1 ring-white/20">
                        <Package className="h-8 w-8 text-white" />
                    </div>
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <span className="text-[10px] font-black uppercase tracking-[0.2em] text-indigo-600 bg-indigo-50 px-2 py-0.5 rounded-md">Real-time Tracking</span>
                            <span className="h-1.5 w-1.5 rounded-full bg-green-500 animate-pulse"></span>
                        </div>
                        <h1 className="text-4xl font-black text-gray-900 tracking-tight">Inventory Management</h1>
                        <p className="text-gray-500 font-medium">Analyze stock levels, track movements, and manage orders</p>
                    </div>
                </div>
                ...
                <div className="flex items-center gap-3">
                    ...
                    <button
                        ...
                        className="flex items-center gap-2 px-6 py-4 bg-gradient-to-br from-indigo-600 to-blue-700 text-white rounded-2xl font-bold shadow-xl shadow-indigo-500/20 hover:scale-[1.02] active:scale-95 transition-all"
                    >
                                        ...
                                        >
                                            <td className="px-8 py-5">
                                                <div className="flex items-center gap-5">
                                                    ...
                                                    <div>
                                                        <p className="font-black text-gray-900 leading-tight group-hover:text-indigo-600 transition-colors uppercase tracking-tight">{item.name}</p>
                                            ...
                                            <td className="px-8 py-5">
                                                <div className={`flex items-center gap-1.5 ${item.demand === 'Top' ? 'text-rose-600' :
                                                    item.demand === 'High' ? 'text-indigo-600' : 'text-gray-400'
                                                    }`}>
                                                    <TrendingUp className="h-4 w-4" />
                                                    <span className="text-xs font-black uppercase tracking-widest">{item.demand}</span>
                                                </div>
                                            </td>
                                            ...
                                            <td className="px-8 py-5 text-right">
                                                <div className="flex items-center justify-end gap-2">
                                                    <button className="p-2.5 text-gray-400 hover:text-indigo-600 hover:bg-white rounded-xl transition-all shadow-sm border border-transparent hover:border-indigo-100 opacity-0 group-hover:opacity-100 scale-90 group-hover:scale-100 duration-300">
                        ...
                        {filteredInventory.map((item: any, idx: number) => (
                            ...
                            >
                                ...
                                <div className="relative">
                                    ...
                                    <h3 className="text-xl font-black text-gray-900 tracking-tight mb-1 group-hover:text-indigo-600 transition-colors uppercase leading-tight">{item.name}</h3>
                                ...
                                <form className="space-y-10" onSubmit={(e) => {
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div className="md:col-span-2 space-y-2">
                                                ...
                                                <input type="text" name="name" required placeholder="e.g. Organic Almond Milk (Unsweetened)" className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold text-gray-900" />
                                            </div>
                                            <div className="space-y-2">
                                                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">SKU / Barcode</label>
                                                <input type="text" name="sku" placeholder="e.g. BEV-008" className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold text-gray-900" />
                                            </div>
                                            <div className="space-y-2">
                                                ...
                                                {isAddingCategory ? (
                                                    <div className="flex gap-2">
                                                        <input
                                                            ...
                                                            className="flex-1 px-5 py-4 bg-indigo-50/50 border border-indigo-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold text-gray-900 placeholder:text-indigo-300"
                                                        ...
                                                        <button
                                                            ...
                                                            className="px-5 bg-indigo-600 text-white rounded-2xl font-bold shadow-lg shadow-indigo-200"
                                                    ...
                                                    <div className="relative group">
                                                        <select name="category_id" className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold text-gray-900 appearance-none cursor-pointer">
                                                            <option value="">Select Category</option>
                                                            {categoriesData.map((c: any) => <option key={c.id} value={c.id}>{c.name}</option>)}
                                                        </select>
                                                        <Box className="absolute right-5 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400 pointer-events-none group-focus-within:text-indigo-500" />
                                                    </div>
                                                )}
                                            </div>
                                        </div>
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div className="space-y-2">
                                                ...
                                                <div className="relative">
                                                    <input type="number" name="stock" placeholder="0" className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold text-gray-900" />
                                            ...
                                            <div className="space-y-2">
                                                ...
                                                <input type="text" name="cost" placeholder="0.00" className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold text-gray-900" />
                                            </div>
                                            <div className="space-y-2">
                                                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">Price (₨)</label>
                                                <input type="text" name="price" required placeholder="0.00" className="w-full px-6 py-4 bg-indigo-50/30 border border-indigo-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-black text-indigo-900" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-center gap-4 pt-6">
                                        ...
                                        <button
                                            ...
                                            className="flex-[2] py-5 bg-gradient-to-br from-indigo-600 to-blue-700 text-white rounded-[2rem] font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-indigo-500/20 hover:scale-[1.02] active:scale-95 transition-all flex items-center justify-center gap-3 disabled:opacity-50"
                                        >
                                ...
                                <form className="space-y-10" onSubmit={(e) => {
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            <div className="md:col-span-2 space-y-2">
                                                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">Product Display Name</label>
                                                <input type="text" name="name" defaultValue={editingProduct.name} required className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold text-gray-900" />
                                            </div>
                                            <div className="space-y-2">
                                                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">SKU / Barcode ID</label>
                                                <input type="text" name="sku" defaultValue={editingProduct.sku} className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold text-gray-900" />
                                            </div>
                                            <div className="space-y-2">
                                                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">Category</label>
                                                <div className="relative group">
                                                    <select name="category_id" defaultValue={editingProduct.category_id} className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold text-gray-900 appearance-none cursor-pointer">
                                                        <option value="">Select Category</option>
                                                        {categoriesData.map((c: any) => <option key={c.id} value={c.id}>{c.name}</option>)}
                                                    </select>
                                                    <Box className="absolute right-5 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400 pointer-events-none group-focus-within:text-indigo-500" />
                                    ...
                                    <div className="space-y-6">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                                            <div className="space-y-2">
                                                ...
                                                <div className="relative">
                                                    <input type="number" name="stock" defaultValue={editingProduct.stock} className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold text-gray-900" />
                                                    <span className="absolute right-6 top-1/2 -translate-y-1/2 text-[10px] font-black text-gray-400 uppercase tracking-widest">Units</span>
                                                </div>
                                            </div>
                                            <div className="space-y-2">
                                                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">Cost (₨)</label>
                                                <input type="text" name="cost" defaultValue={editingProduct.cost || ""} className="w-full px-6 py-4 bg-gray-50 border border-gray-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-bold text-gray-900" />
                                            </div>
                                            <div className="space-y-2">
                                                <label className="text-[10px] font-black uppercase tracking-[0.2em] text-gray-400 ml-1">Price (₨)</label>
                                                <input type="text" name="price" defaultValue={editingProduct.price} required className="w-full px-6 py-4 bg-indigo-50/30 border border-indigo-100 rounded-2xl focus:outline-none focus:ring-4 focus:ring-indigo-500/10 focus:border-indigo-500 transition-all font-black text-indigo-900" />
                                            </div>
                                        </div>
                                    </div>
            ...
            <div className="p-8 bg-gradient-to-br from-gray-900 to-gray-800 rounded-[3rem] shadow-2xl relative overflow-hidden text-white flex flex-col md:flex-row items-center justify-between gap-8 group">
                <div className="absolute right-0 top-0 h-64 w-64 bg-indigo-500/10 rounded-full blur-[100px] -mr-32 -mt-32"></div>
                <div className="relative flex items-center gap-6">
                    ...
                    <div>
                        ...
                        <p className="text-white/60 font-medium max-w-md">There are <span className="text-indigo-400 font-black">2 critical</span> items and <span className="text-indigo-400 font-black">18 warning</span> stock levels currently requiring attention.</p>
                    </div>
                </div>
                <button className="relative px-8 py-5 bg-white text-gray-900 rounded-[2rem] font-black text-sm uppercase tracking-widest shadow-xl hover:scale-105 active:scale-95 transition-all duration-300 flex items-center gap-3">
                    Start Auto-Reorder <ArrowRight className="h-5 w-5" />
                </button>
            </div>
        </div>
    )
